...
def interface():
    with gr.Blocks(css=display_css) as demo:
        with gr.Column():
            gr.Markdown("<h1 style='text-align: center;'>OmniGen: Unified Image Generation</h1>")
            gr.Markdown("<p style='text-align: center;'>More information please refer to our repo: <a href='https://github.com/VectorSpaceLab/OmniGen'>https://github.com/VectorSpaceLab/OmniGen</a></p>")
